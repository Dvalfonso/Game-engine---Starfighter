...
import ar.edu.unrc.dc.models.projectileMovement.RightTopMovementProjectile;

public class RightTopMovementTest {

    Position initialPos;
    RightTopMovementProjectile movement;

    @BeforeEach
    public void setup() {
        initialPos = new Position(0,0);
        movement = new RightTopMovementProjectile(initialPos);
    }
